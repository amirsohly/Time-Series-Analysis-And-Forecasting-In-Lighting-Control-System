...
export default {
  data() {
    return {
      ...
      sidebarImages: [
        { image: require("@/assets/img/a.png"), active: false },
        { image: require("@/assets/img/b.png"), active: true },
        { image: require("@/assets/img/c.png"), active: false },
        { image: require("@/assets/img/d.png"), active: false },
      ],
    };
  },
  methods: {
